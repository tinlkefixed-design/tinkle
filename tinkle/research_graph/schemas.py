...
class RelationshipType(str, Enum):
    ...
    PLANS_EXPERIMENT = "PLANS_EXPERIMENT"
    TARGETS_HYPOTHESIS = "TARGETS_HYPOTHESIS"
    ...
    PREDICTS_OUTCOME = "PREDICTS_OUTCOME"
    ...
    UPDATES_EVIDENCE = "UPDATES_EVIDENCE"
    IMPACTS_DECISION = "IMPACTS_DECISION"
    SATISFIES_VALIDATION = "SATISFIES_VALIDATION"
